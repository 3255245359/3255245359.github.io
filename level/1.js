...
//         PlayAudio("dirt_rise", true); (function(e, g, a, d, c, f, b) {
//             e += 15;
//             g += 16;
//             d += 16;
...
//                 top: ++b + "px"
//             });
//             e < 755 ? oSym.addTask(3, arguments.callee, [e, g, a, d, c, f, b]) : (PauseAudio("dirt_rise"), ClearChild($("SodRoll"), $("SodRollCap")), (function() {
...
},
{
    ...
    FlagToEnd: function() {
        NewImg("imgSF", "images/Card/Plants/Repeater.png", "left:50%;top:50%;clip:rect(auto,auto,60px,auto)", EDAll, {
            onclick: function() {
                GetNewCard(this, oRepeater, 10)
            }
        });
