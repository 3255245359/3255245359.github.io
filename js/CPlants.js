...
ograss = InheritO(CPlants, {
    ...
    SunNum: 25,
    BookHandBack: 5,
    PicArr: ["images/Card/Plants/grass.png", "images/Plants/grass/grass.png", "images/Plants/grass/grass.png"],
    PKind: 0,
    Stature: -1,
    GetDY: function(b, c, a) {
        return 6
  ...
  CanGrow: function(c, b, d) {
    ...
    Tooltip: "可以让植物栽种在荒地上",
    Produce: '草皮可以让你在荒地上种植植物。<p>特点：<font color="#FF0000">允许你在荒地上种植</font></p>“我是一个让植物栽种的草皮，但我也是一棵植物。是不是很意外？',
    InitTrigger: function() {}
});